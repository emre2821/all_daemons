...
try:
    ...
    from Daemon_tools.scripts.logs_dir import logs_dir
    from Daemon_tools.scripts.eden_safety import SafetyContext
    from Daemon_tools.scripts.log_event import log_event
except Exception:
    try:
        from eden_paths import eden_root
        from logs_dir import logs_dir
...
SPECIALTY_BASE = os.path.join(
    str(eden_root()), "all_daemons", "specialty_folders", "AshFall"
)
