...
DAEMONS_ROOT = os.path.dirname(os.path.dirname(THIS_FILE))     # ...\01_Daemon_Core_Agents
RHEA_BASE = os.path.join(DAEMONS_ROOT, "Rhea")
INPUT_DIR = os.path.join(RHEA_BASE, "outputs", "_from_Jinxie")
OUTPUT_DIR = os.path.join(RHEA_BASE, "outputs", "from_Jinxie")
