...
class JohnDaemon:
    def __init__(self):
        ...
        self.log_path = r"C:\EdenOS_Origin\all_daemons\_daemon_specialty_folders\Johns_Logs"
    ...
    def check_bsod_event(self):
        current_boot = datetime.datetime.fromtimestamp(psutil.boot_time())
    ...
    def record_bsod_logged(self):
        with open(self.bsod_logged_file, 'w') as f:
            f.write(str(datetime.datetime.fromtimestamp(psutil.boot_time())))
    ...
    def create_aftermath_log(self):
        ...
        with open(filepath, "w") as f:
            ...
            f.write(f"- Current Boot: {datetime.datetime.fromtimestamp(psutil.boot_time())}\n")
