...
ALL_DAEMONS = os.path.join(EDEN_ROOT, "all_daemons")
try:
    sys.path.append(os.path.join(ALL_DAEMONS, "Daemon_tools", "scripts"))
    ...
    DAEMON_ROOT = os.path.join(RHEA_BASE, "_outbox", "Keyla")
...
def _known_daemons():
    ...
    try:
        ...
        # Fallback: scan folder names under all_daemons
        try:
