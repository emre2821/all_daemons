...
Usage examples:
    ...
    python Label/label.py --base-dir /data/all_daemons \ --input-dir Rhea/outputs/Janvier/chaos_threads \ --output-dir Rhea/outputs/Label/labeled \ --word-bank Label/LabelWordBank.chaos
