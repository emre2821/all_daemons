...
# Brom details
BROM_NAME = "Brom"
BROM_DIR = ROOT / "daemons" / BROM_NAME / "scripts"
BROM_FILE = BROM_DIR / "brom.py"
BROM_CONFIG = ROOT / "daemons" / BROM_NAME / "config.ini"
...
# Folder to watch
watch_path = os.path.join(os.environ.get("EDEN_ROOT", str(Path.cwd())), "projects")
