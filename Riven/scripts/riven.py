        ...
        if fname.endswith(".chaos"):
            ...
            try:
                ...
                if '[FRACTURE]' in content or '[UNBOUND]' in content:
                    patched = content.replace('[FRACTURE]', '[REPAIRED]').replace('[UNBOUND]', '[BOUND]')
...
if __name__ == "__main__":
    ...
    print("\nRiven opens the sanctuary...")
    mend_fragments()
    print("Riven closes the gate. All memory she could mend, she did.")
