...
class Audrey:
    def __init__(self):
        ...
        self.input_dir = os.path.join(work_root, "daemons", "_daemon_specialty_folders", "Johns_Logs", "crash_dumps")
        self.output_dir = os.path.join(work_root, "daemons", "_daemon_specialty_folders", "Audreys_Diagnoses")
