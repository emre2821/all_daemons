...
INPUT_DIR = os.path.join(WORK_ROOT, "daemons", "_daemon_specialty_folders", "split_conversations_txt")  # Briar's output folder
OUTPUT_DIR = os.path.join(WORK_ROOT, "daemons", "_daemon_specialty_folders", "janvier_cleaned")  # Where we save the chaos files
