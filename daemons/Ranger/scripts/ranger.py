...
EDEN_ROOT = os.getenv("EDEN_ROOT", os.getcwd())
WORK_ROOT = os.getenv("EDEN_WORK_ROOT", EDEN_ROOT)
...
RHEA_INBOX = os.path.join(WORK_ROOT, "daemons", "Rhea", "_inbox")
...
CONFIG_PATH = os.getenv(
    "RANGER_HUNTS_INI",
    os.path.join(EDEN_ROOT, "daemons", "Ranger", "ranger.hunts.ini"),
)
