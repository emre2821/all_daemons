...
WATCH_DIR = EDEN_ROOT / "meetings" / "QuickSit"
...
def make_plan(text: str) -> str:
    ...
    Write a 3-item, low-friction action plan:
    - Item 1: Shelter/safety options
    - Item 2: Cash options (fast, legal, simple)
    - Item 3: Harm-reduction/health steps
