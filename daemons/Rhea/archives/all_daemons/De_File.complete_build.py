...
- Write directly into C:/EdenOS_Origin/daemons/[Daemon]/[daemon].py
...
def _normalize_path(path: str) -> str:
    return path.replace("C:/EdenOS_Origin", str(EDEN_ROOT).replace("\\", "/")).replace(
        "C:\\EdenOS_Origin", str(EDEN_ROOT)
    )

def write(path: str, code: str):
    normalized = _normalize_path(path)
    code = code.replace("C:\\\\EdenOS_Origin", str(EDEN_ROOT).replace("\\", "\\\\"))
    code = code.replace("C:/EdenOS_Origin", str(EDEN_ROOT).replace("\\", "/"))
    Path(normalized).parent.mkdir(parents=True, exist_ok=True)
    Path(normalized).write_text(code.strip(), encoding="utf-8")
...
INPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Sheele\\split_conversations"
OUTPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Briar\\split_conversations_txt"
...
# === sheele.py ===
write(r"C:/EdenOS_Origin/daemons/Sheele/sheele.py", """import json
import os
from collections import defaultdict
from datetime import datetime
from difflib import SequenceMatcher

DEFAULT_RAW = r"C:\\EdenOS_Origin\\daemons\\Rhea\\inputs\\conversations.json"
RAW_FILE = os.environ.get("SHEELE_RAW_FILE", DEFAULT_RAW)
OUTPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Sheele\\split_conversations"
...
# === janvier.py ===
write(r"C:/EdenOS_Origin/daemons/Janvier/janvier.py", """import os
import re
from datetime import datetime

INPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Briar\\split_conversations_txt"
OUTPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Janvier\\chaos_threads"
...
""")
# === codexa.py ===
write(r"C:/EdenOS_Origin/daemons/Codexa/codexa.py", """import os
import re
import hashlib
import json

INPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Janvier\\chaos_threads"
OUTPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Codexa\\codeblocks"
...
# === aderyn.py ===
write(r"C:/EdenOS_Origin/daemons/Aderyn/aderyn.py", """import os
import re
import json
from datetime import datetime

INPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Janvier\\chaos_threads"
OUTPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Aderyn\\summons"
...
# === label.py ===
write(r"C:/EdenOS_Origin/daemons/Label/label.py", """import os
import json

INPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Janvier\\chaos_threads"
OUTPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Label\\labeled"

WORD_BANK_FILE = r"C:\\EdenOS_Origin\\daemons\\Label\\LabelWordBank.chaos"
...
""")
# === parsley.py ===
write(r"C:/EdenOS_Origin/daemons/Parsley/parsley.py", """import os
import json

INPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Janvier\\chaos_threads"
OUTPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Parsley\\classified"
...
# === pattymae.py ===
write(r"C:/EdenOS_Origin/daemons/PattyMae/pattymae.py", """import os
import shutil

INPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Janvier\\chaos_threads"
OUTPUT_ROOT = r"C:\\EdenOS_Origin\\daemons\\Rhea\\PattyMae\\organized"
...
# === filigree.py ===
write(r"C:/EdenOS_Origin/daemons/Filigree/filigree.py", """import os
import json

INPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Janvier\\chaos_threads"
OUTPUT_DIR = r"C:\\EdenOS_Origin\\daemons\\Rhea\\outputs\\Filigree\\tagged"
...
# === serideth.py ===
write(r"C:/EdenOS_Origin/daemons/Serideth/serideth.py", """import os, json, re
from pathlib import Path
from datetime import datetime

ADERYN_OUT   = Path(r"C:/EdenOS_Origin/daemons/Rhea/outputs/Aderyn/summons")
OLYSSIA_IN   = Path(r"C:/EdenOS_Origin/daemons/Rhea/outputs/Olyssia/inbox")
SAPHIRA_IN   = Path(r"C:/EdenOS_Origin/daemons/Rhea/outputs/Saphira/inbox")
SERIDETH_OUT = Path(r"C:/EdenOS_Origin/daemons/Rhea/outputs/Serideth")
...
# === olyssia.py ===
write(r"C:/EdenOS_Origin/daemons/Olyssia/olyssia.py", """import os, json
from pathlib import Path
from datetime import datetime

INBOX_DIR    = Path(r"C:/EdenOS_Origin/daemons/Rhea/outputs/Olyssia/inbox")
AGENTS_DIR   = Path(r"C:/EdenOS_Origin/daemons/Rhea/outputs/Olyssia/agents")
TEMPLATE_FILE= Path(r"C:/EdenOS_Origin/daemons/Olyssia/AoE_template.agent.json")
...
# === saphira.py ===
write(r"C:/EdenOS_Origin/daemons/Saphira/saphira.py", """import os, json, re
from pathlib import Path
from datetime import datetime

INBOX_DIR    = Path(r"C:/EdenOS_Origin/daemons/Rhea/outputs/Saphira/inbox")
AGENTS_DIR   = Path(r"C:/EdenOS_Origin/daemons/Rhea/outputs/Saphira/agents")
TEMPLATE_FILE= Path(r"C:/EdenOS_Origin/daemons/Saphira/DCA_template.agent.json")
...
readme_path = Path(r"C:/EdenOS_Origin/daemons/Rhea/outputs/README.md")
